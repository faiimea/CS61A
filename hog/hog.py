...
def more_boar(player_score, opponent_score):
    ...
    while(opponent_score>99):
      opponent_score//=10
    player_two=player_score%10
    if(player_score<10):
      player_one=0
    else:
      player_one=(player_score//10)%10
    opp_two=opponent_score%10
    if(opponent_score<10):
      opp_one=0
    else:
      opp_one=(opponent_score//10)%10
    if (player_one<opp_one)and(player_two<opp_two):
      return True
    else:
      return False
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while(max(score0,score1)<goal):
      if(who==0):
        ...
        mb=more_boar(score0,score1)
      else:
        score1+=take_turn(strategy1(score1,score0), score0, dice, goal)
        mb=more_boar(score1,score0)
      if(not mb):
        who=next_player(who)
      mb=False
      my_say=my_say(score0, score1)
    # END PROBLEM 5
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
      ...
      if(temp>running_high):  
        ...
        return announce_highest(who, ori,temp)
      else:
        return announce_highest(who, ori,running_high)
    return say
